...
|---|---|---|---|---|
| **P** | Panel | Dos paneles fijos lado a lado. `height: 100dvh; overflow: hidden`. Panel izquierdo = configuración / input; panel derecho = preview / output en tiempo real. | `variant="compact"` en el header (siempre visible) | bg, pc, reading, hgs, listening |
...
#### Mapa de los 14 dashboards existentes
...
| `dashboard-stp.html` | **PBH** | Panel | CSV→chips | Hub | Spell the Phrase — chips excluibles |
...
- Campos guardados en Firestore: `level`, `category`, `topic`
