...
window.PERIPLO_TAXONOMY = (() => {
    const TAXONOMY = {
        basic: {
            ...
            key_structs: ["WH Questions","FANBOYS & Correlative","Subordinating Conj.","Prep. Time","Prep. Place","Prep. Movement & Other","Object Pronouns","Possessive Pronouns","Quantifiers","Frequency Adverbs","Otro"],
            otro:        ["Otro"]
        },
        advanced: {
