...
window.PERIPLO_TAXONOMY = (() => {
    const TAXONOMY = {
        basic: {
            ...
            key_structs: ["WH Questions","Prep. Place","Frequency Adverbs","FANBOYS & Correlative","Subordinating Conj.","Prep. Time","Prep. Movement & Other","Object Pronouns","Quantifiers","Possessive Pronouns","Otro"],
            otro:        ["Otro"]
        },
        advanced: {
